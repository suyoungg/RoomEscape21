...
namespace Room_Escape_by_VISIONARIES
{
    public partial class frmMain : Form
    {
        ...
        private void picTowel()
        {
            ...
            Towel.Width = 70;
            Towel.Height = 80;
            Towel.Location = new Point(770, 470);
        ...
        private void towel_paint(object sender, PaintEventArgs e)
        {
            Graphics g = e.Graphics;
            Image ImageBlend = backbuffer2;
            rectSource = new Rectangle(770, 470, Towel.Width, Towel.Height);
        ...
        private void picCup()
        {
            ...
            Cup.Width = 70;
            Cup.Height = 100;
            Cup.Location = new Point(770, 570);
            Cup.Click += cup_click;
        ...
        private void cup_paint(object sender, PaintEventArgs e)
        {
            Graphics g = e.Graphics;
            Image ImageBlend = backbuffer2;
            rectSource = new Rectangle(770, 570, Cup.Width, Cup.Height);
